    ...
    public class FindPe
    {
        ...
        static string FindPeFromPath(string ModuleName, List<string> CandidateFolders, bool Wow64Dll = false)
        {
            ...
            foreach (String CandidatePath in CuratedCandidateFolders)
            {
                ...
                PE TestPe = BinaryCache.LoadPe(PeFilePath); //TODO why doesn't it cache ModuleName + isWow64Dll? Checking for each path would be reduced to checking for each ModuleName.
        ...
        //      6. AppDatas
        //      }
        public static Tuple<ModuleSearchStrategy, string> FindPeFromDefault(PE RootPe, string ModuleName, SxsEntries SxsCache, List<string> CustomSearchFolders, List<ModuleSearchStrategy> IgnoreSearchStrategies, string WorkingDirectory)
        {
            ...
            if (IgnoreSearchStrategies.Contains(ModuleSearchStrategy.SxS))
            {
                if (SxsCache.Count != 0)
                {
            ...
            if (IgnoreSearchStrategies.Contains(ModuleSearchStrategy.WellKnownDlls))
            {
            ...
            if (IgnoreSearchStrategies.Contains(ModuleSearchStrategy.ApplicationDirectory))
            {
            ...
            if (IgnoreSearchStrategies.Contains(ModuleSearchStrategy.WindowsFolder))
            {
            ...
            if (IgnoreSearchStrategies.Contains(ModuleSearchStrategy.WorkingDirectory))
            {
            ...
            // 7. Find in PATH
            if (IgnoreSearchStrategies.Contains(ModuleSearchStrategy.Environment))
            {
            ...
            if (IgnoreSearchStrategies.Contains(ModuleSearchStrategy.Fullpath))
            {
            ...
            // specific cases.
            if (IgnoreSearchStrategies.Contains(ModuleSearchStrategy.UserDefined))
            {
